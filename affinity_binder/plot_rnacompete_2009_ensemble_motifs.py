#---------------------------------------------------------------------------------------
"""
Summary: Train a simple model on the saliency maps of the ensemble of models
...
for ss_type in ss_types:
	...
	for rbp_name in rbp_names:
		...
		motif_path = helper.make_directory(classifier_path, rbp_name)
		...
		for num_saliency in num_saliencies:
			...
			mean_saliency, guided_saliency = helper.ensemble_saliency(X, models, best_path, rbp_name,
													input_shape, output_shape, use_scope=True)
