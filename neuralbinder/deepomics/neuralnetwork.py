...
from neuralbinder.deepomics import optimize, metrics, utils
from neuralbinder.deepomics.neuralbuild import NeuralBuild
...
class NeuralNet:
	...
	def build_layers(self, model_layers, optimization=None, method=None, supervised=True, use_scope=True, reset=True):
		...
		if use_scope:
			from neuralbinder.deepomics.neuralbuild_scope import NeuralBuild
		else:
			from neuralbinder.deepomics.neuralbuild import NeuralBuild
